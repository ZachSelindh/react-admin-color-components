...
var _excluded = ["className", "colorSquareOptions", "helperText", "label", "picker", "pickerOptions", "pickerHeader", "resource", "source"];
...
var ColorInput = function ColorInput(props) {
  var className = props.className,
    ...
    pickerHeader = props.pickerHeader,
  ...
  var translateLabel = (0, _reactAdmin.useTranslateLabel)();
...
ColorInput.propTypes = {
  ...
  pickerHeader: _propTypes["default"].string
};
